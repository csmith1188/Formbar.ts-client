...
import { darkenButtonColor, textColorForBackground } from '../CustomStyleFunctions';
...
export default function PollButton({answerData, Respond}: {answerData: answer, Respond: (response: string) => void}) {
    ...
    return (
        <Button variant="solid" style={{marginTop: '5px', width: 'auto'}} onClick={() => Respond(answerData.answer)} 
            styles={
                answerStyleState[answerStyleState.current]
            } 
            onMouseEnter={() => {
