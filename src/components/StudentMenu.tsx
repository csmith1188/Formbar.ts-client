    ...
    return (
        <>
            <FloatButton.Group
                ...
                icon={<IonIcon icon={IonIcons.grid} style={{fontSize:'36px',display:'flex'}} />}
                tooltip={{
                    title: 'Menu',
                    color: 'blue',
                    placement: 'left'
            ...
            >
                <FloatButton
                    ...
                    icon={<IonIcon icon={IonIcons.handLeftOutline} style={{fontSize:'36px',display:'flex', filter:'invert(1)'}} />}
                />
                <FloatButton
                    shape="circle"
                    type="primary"
                    ...
                    icon={<IonIcon icon={IonIcons.umbrellaOutline} style={{fontSize:'36px',display:'flex', filter:'invert(1)'}} />}
            ...
            <Modal
                ...
                onOk={() => {setHelpModalOpen(false); sendHelpTicket(helpReason)}}
            >
                <Input.TextArea 
            ...
            <Modal
                ...
                onOk={() => {setBreakModalOpen(false); requestBreak(breakType === 'Other' ? breakReason : breakType)}}
            >
                <Radio.Group 
